...
import { Code2, Cloud, Database, Cpu, ArrowRight, CheckCircle2 } from "lucide-react";
    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-12 relative z-10">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-5xl md:text-8xl font-heading font-black text-white mb-8 tracking-tighter uppercase leading-[0.9]">
              INFORMATION <br className="hidden md:block" /> TECHNOLOGY (IT)
            </h1>
            <p className="text-gray-400 text-xl md:text-2xl font-medium max-w-2xl leading-relaxed">
              Hiring across software development, cloud, data, and infrastructure roles for startups, enterprises, and product companies.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <p className="text-xl text-maxera-text/80 mb-8 leading-relaxed">
              The technology landscape is defined by its talent. We help you find the specialists who can build, scale, and secure your digital future.
            </p>
            <div className="space-y-4 mb-10">
               {[
                 "Vetted technical experts across all stacks",
                 "Support for startups and large enterprises",
                 "Focused technical screening and role-fit",
                 "Faster closures for critical tech roles"
               ].map((item, idx) => (
      ...
      <section className="bg-maxera-red py-32 relative overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl md:text-6xl text-white font-black mb-12 tracking-tighter uppercase italic">Need a specialized tech skill set?</h2>
