...
import { Truck, Users, MapPin, Zap, ArrowRight, CheckCircle2 } from "lucide-react";
  ...
  const specializations = [
    {
      ...
      description: "Sourcing experienced and verified drivers for HGV, LCV, and logistics fleets.",
      icon: Truck
    },
    {
      title: "Logistics Support",
      description: "Recruiting dispatchers, fleet coordinators, and logistics support staff.",
      icon: MapPin
    },
    {
      title: "Mobility Operations",
      description: "Providing workforce solutions for mobility platforms and urban delivery networks.",
      icon: Zap
    },
    {
      title: "Last-Mile Delivery",
      description: "High-volume sourcing for delivery fleets and last-mile distribution operations.",
      icon: Users
    }
  ];
    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-12 relative z-10">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-5xl md:text-8xl font-heading font-black text-white mb-8 tracking-tighter uppercase leading-[0.9]">
              TRANSPORTATION & <br className="hidden md:block" /> DRIVERS
            </h1>
            <p className="text-gray-400 text-xl md:text-2xl font-medium max-w-2xl leading-relaxed">
              Sourcing drivers and logistics support staff for mobility and delivery operations with speed and reliability.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <p className="text-xl text-maxera-text/80 mb-8 leading-relaxed">
              The transportation sector is the pulse of the economy. We provide verified, reliable talent for fleet operations and last-mile delivery to ensure your business stays in motion.
            </p>
            <div className="space-y-4 mb-10">
               {[
                 "Verified and background-checked drivers",
                 "Fleet and dispatch coordination talent",
                 "Support for high-volume mobility platforms",
                 "Safety and compliance focused sourcing"
               ].map((item, idx) => (
      ...
      <section className="bg-maxera-red py-32 relative overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl md:text-6xl text-white font-black mb-12 tracking-tighter uppercase italic">Need verified drivers or fleet support?</h2>
          <Link href="/contact" className="skew-btn bg-maxera-dark px-16 py-6 inline-block text-white font-black uppercase tracking-widest hover:bg-white hover:text-maxera-red transition-all shadow-2xl">
            <span className="skew-content flex items-center">
               Initiate Fleet Sourcing <ArrowRight className="ml-3 w-5 h-5" />
            </span>
          </Link>
        </div>
      </section>
