    ...
    <div className="space-y-8 pb-20">
      <div>
        ...
        <p className="text-zinc-500 mt-1 font-medium italic">
          Data-driven insights for Maxera Talent ecosystem.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {statCards.map((stat, idx) => (
          <div
            key={idx}
            className="bg-white dark:bg-zinc-900 p-6 rounded-3xl border border-zinc-100 dark:border-zinc-800 shadow-sm relative overflow-hidden group"
          >
            <div
              className={`absolute top-0 right-0 w-24 h-24 rounded-full -mr-8 -mt-8 group-hover:scale-110 transition-transform ${
                stat.color === "blue"
                  ? "bg-blue-500/5"
                  : stat.color === "purple"
                    ? "bg-purple-500/5"
            ...
            <div className="mt-4 flex items-center gap-2 relative z-10">
              <span
                className={`flex items-center text-[10px] font-bold ${stat.isPositive ? "text-emerald-600" : "text-red-600"}`}
              >
                {stat.isPositive ? (
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-xs text-zinc-400 font-medium">
                Daily visitor analysis across platform nodes.
              </p>
            </div>
        ...
        <div className="lg:col-span-4 space-y-8">
          <div className="bg-zinc-900 text-white p-8 rounded-3xl shadow-xl relative overflow-hidden">
            ...
            <p className="text-white/60 text-xs mb-8">
              Maxera Talent is expanding its institutional reach by 15.4% this
              quarter.
            </p>
          ...
          <div className="bg-white dark:bg-zinc-900 p-8 rounded-3xl border border-zinc-100 dark:border-zinc-800">
            <h3 className="text-sm font-black text-zinc-900 dark:text-white uppercase tracking-widest mb-6 border-b border-zinc-100 dark:border-zinc-800 pb-4">
              Top Channels
            </h3>
                ...
                data.topChannels.map((channel: any, idx: number) => (
                  ...
                  >
                    ...
                    <span className="text-xs font-black text-zinc-900 dark:text-white">
                      {Math.round(
                        (channel.value / (data.stats?.enquiries || 1)) * 100,
                      )}
                      %
                    </span>
                  </div>
