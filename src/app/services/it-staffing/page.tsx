...
import { Code2, Cpu, Database, Cloud, ArrowRight, CheckCircle2 } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Recruiting top-tier developers across full-stack, mobile, and specialized languages.",
      icon: Code2
    },
    {
      title: "Cloud & Infrastructure",
      description: "Finding experts in AWS, Azure, GCP, and DevOps to build resilient systems.",
      icon: Cloud
    },
    {
      title: "Data & Analytics",
      description: "Connecting you with data scientists, analysts, and engineers who drive insight.",
      icon: Database
    },
    {
      title: "Product & Design",
      description: "Sourcing visionary product managers and UI/UX designers for modern apps.",
      icon: Cpu
    }
  ];
    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-12 relative z-10">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-5xl md:text-8xl font-heading font-black text-white mb-8 tracking-tighter uppercase leading-[0.9]">
              IT <br className="hidden md:block" /> STAFFING
            </h1>
            <p className="text-white/80 text-xl md:text-2xl font-medium max-w-2xl leading-relaxed">
              Specialized hiring for developers, cloud, and technology professionals using targeted sourcing and technical screening.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-xl text-maxera-text/80 mb-8 leading-relaxed">
              In a competitive tech landscape, finding the right talent is the difference between leading and lagging. We understand technical nuances and role expectations deeply.
            </p>
            <div className="space-y-4 mb-10">
               {[
                 "Targeted sourcing for niche technologies",
                 "Technical screening to ensure role-fit",
                 "Startup and enterprise experienced talent",
                 "Faster closures with high-impact candidates"
               ].map((item, idx) => (
      ...
      <section className="bg-maxera-dark py-32 relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl md:text-6xl text-white font-black mb-12 tracking-tighter uppercase italic">Need a technical expert?</h2>
          <Link href="/contact" className="skew-btn bg-white px-16 py-6 inline-block text-maxera-red font-black uppercase tracking-widest hover:bg-gray-100 transition-all shadow-2xl">
            <span className="skew-content flex items-center">
               Hire Tech Talent <ArrowRight className="ml-3 w-5 h-5" />
            </span>
          </Link>
        </div>
      </section>
