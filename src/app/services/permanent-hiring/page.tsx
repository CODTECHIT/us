...
import { UserPlus, ShieldCheck, Heart, Search, ArrowRight, CheckCircle2 } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Focusing on candidates who match your company culture and long-term vision.",
      icon: Heart
    },
    {
      title: "Skill Validation",
      description: "Multi-stage assessment to ensure technical and soft skills meet role expectations.",
      icon: Search
    },
    {
      title: "Retention Focus",
      description: "Targeting professionals with a track record of stability and commitment.",
      icon: ShieldCheck
    },
    {
      title: "Foundational Roles",
      description: "Finding the key people who will drive your organization forward for years.",
      icon: UserPlus
    }
  ];
    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-12 relative z-10">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-5xl md:text-8xl font-heading font-black text-white mb-8 tracking-tighter uppercase leading-[0.9]">
              PERMANENT <br className="hidden md:block" /> STAFFING
            </h1>
            <p className="text-white/80 text-xl md:text-2xl font-medium max-w-2xl leading-relaxed">
              End-to-end hiring support for full-time roles, ensuring strong alignment between skills and long-term fit.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="text-4xl md:text-5xl font-heading font-black text-maxera-dark mb-8 tracking-tighter uppercase">
              Build Your Forever Team
            </h2>
            <p className="text-xl text-maxera-text/80 mb-8 leading-relaxed">
              Recruitment is not just about filling a seat—it's about building a foundation. We use deep consultative search to find candidates who thrive in your environment.
            </p>
            <div className="space-y-4 mb-10">
               {[
                 "In-depth candidate vetting and screening",
                 "Strong alignment with role expectations",
                 "IT & Non-IT specialized search units",
                 "High retention rates for placed talent"
               ].map((item, idx) => (
      ...
      <section className="bg-maxera-dark py-32 relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl md:text-6xl text-white font-black mb-12 tracking-tighter uppercase italic">Strategic hiring for long-term growth?</h2>
          <Link href="/contact" className="skew-btn bg-white px-16 py-6 inline-block text-maxera-red font-black uppercase tracking-widest hover:bg-gray-100 transition-all shadow-2xl">
            <span className="skew-content flex items-center">
               Initiate Direct Hire <ArrowRight className="ml-3 w-5 h-5" />
            </span>
          </Link>
        </div>
      </section>
