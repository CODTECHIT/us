...
import { Users, Zap, Layers, Rocket, ArrowRight, CheckCircle2 } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Fast-tracked onboarding processes designed to get teams on-site within record timelines.",
      icon: Zap
    },
    {
      title: "Volume Management",
      description: "Infrastructure built to handle 100+ hires per month with consistent quality control.",
      icon: Layers
    },
    {
      title: "Ground-Level Sourcing",
      description: "Extensive networks in industrial and logistics hubs for real-time talent access.",
      icon: Users
    },
    {
      title: "Operational Scale",
      description: "Supporting large distribution centers, production units, and seasonal surges.",
      icon: Rocket
    }
  ];
    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-12 relative z-10">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-5xl md:text-8xl font-heading font-black text-white mb-8 tracking-tighter uppercase leading-[0.9]">
              VOLUME <br className="hidden md:block" /> RECRUITMENT
            </h1>
            <p className="text-white/80 text-xl md:text-2xl font-medium max-w-2xl leading-relaxed">
              Rapid workforce deployment for large-scale hiring needs. Built for high-volume mandates with consistent delivery.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="text-4xl md:text-5xl font-heading font-black text-maxera-dark mb-8 tracking-tighter uppercase">
              Scale Without The Bottlenecks
            </h2>
            <p className="text-xl text-maxera-text/80 mb-8 leading-relaxed">
              When your business needs to scale fast, you can&apos;t afford hiring delays. Maxera Talent specializes in high-volume deployment across logistics, operations, and industrial roles.
            </p>
            <div className="space-y-4 mb-10">
               {[
                 "Consistent delivery for high-volume mandates",
                 "Fast turnaround on frontline roles",
                 "Logistics and industrial specialization",
      ...
      <section className="bg-maxera-dark py-32 relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl md:text-6xl text-white font-black mb-12 tracking-tighter uppercase italic">Ready for high-volume deployment?</h2>
          <Link href="/contact" className="skew-btn bg-white px-16 py-6 inline-block text-maxera-red font-black uppercase tracking-widest hover:bg-gray-100 transition-all shadow-2xl">
            <span className="skew-content flex items-center">
               Initiate Bulk Hiring <ArrowRight className="ml-3 w-5 h-5" />
            </span>
          </Link>
        </div>
      </section>
