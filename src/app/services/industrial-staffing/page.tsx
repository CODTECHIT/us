...
import { Factory, Settings, Truck, Construction, ArrowRight, CheckCircle2 } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Sourcing verified talent for production units, factories, and assembly lines.",
      icon: Settings
    },
    {
      title: "Manufacturing Focus",
      description: "Dedicated units for electronics, automotive, and general manufacturing sectors.",
      icon: Factory
    },
    {
      title: "Logistics Support",
      description: "Workforce solutions for distribution centers and large-scale warehouse operations.",
      icon: Truck
    },
    {
      title: "Construction Ops",
      description: "Providing technicians, electricians, and on-site project support roles.",
      icon: Construction
    }
  ];
    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-12 relative z-10">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-5xl md:text-8xl font-heading font-black text-white mb-8 tracking-tighter uppercase leading-[0.9]">
              INDUSTRIAL <br className="hidden md:block" /> STAFFING
            </h1>
            <p className="text-white/80 text-xl md:text-2xl font-medium max-w-2xl leading-relaxed">
              Reliable workforce solutions for construction, manufacturing, and logistics sectors, backed by ground-level sourcing.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-xl text-maxera-text/80 mb-8 leading-relaxed">
              From manufacturing units to distribution centers, we deliver reliable, skill-validated workforce solutions that keep your operations running smoothly.
            </p>
            <div className="space-y-4 mb-10">
               {[
                 "Ground-level sourcing for high accessibility",
                 "Stringent skill validation processes",
                 "Safety and compliance focused onboarding",
      ...
      <section className="bg-maxera-dark py-32 relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl md:text-6xl text-white font-black mb-12 tracking-tighter uppercase italic">Need a reliable industrial workforce?</h2>
          <Link href="/contact" className="skew-btn bg-white px-16 py-6 inline-block text-maxera-red font-black uppercase tracking-widest hover:bg-gray-100 transition-all shadow-2xl">
            <span className="skew-content flex items-center">
               Initiate Industrial Search <ArrowRight className="ml-3 w-5 h-5" />
            </span>
          </Link>
        </div>
      </section>
