...
const ValueCard = ({
  ...
  <AnimatedContent delay={delay} direction="up" distance={30}>
    <SpotlightCard className="bg-white p-6 sm:p-8 md:p-10 border border-gray-100 hover:shadow-xl transition-all duration-300 h-full">
      ...
      <h3 className="text-lg sm:text-xl font-bold text-maxera-dark mb-2 sm:mb-3 md:mb-4">
        {title}
      </h3>
    ...
    <div className="bg-white page-transition">
      ...
      <section className="pt-12 sm:pt-16 md:pt-20 pb-24 sm:pb-32 md:pb-40 bg-maxera-dark relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-maxera-red">
          <Aurora
            colorStops={["#C6093C", "#8B0000", "#ff4d6d"]}
            amplitude={1.0}
            blend={0.6}
            speed={0.2}
          />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 sm:gap-16 items-start">
            <div className="lg:col-span-7">
              <AnimatedContent direction="left">
                <span className="text-maxera-red font-bold text-sm tracking-[0.3em] uppercase mb-4 md:mb-6 block">
                  Our Story
                </span>
                ...
                <div className="space-y-6 md:space-y-8 text-gray-500 font-medium text-base sm:text-lg md:text-xl leading-relaxed">
                  <p className="text-maxera-dark font-bold leading-tight border-l-4 border-maxera-red pl-6 py-2">
                    Maxera Talent is a recruitment and staffing partner built to
                    solve one problem: finding the right people, fast, without
                    compromising on quality.
                  </p>

                  <p>
                    We specialize in delivering workforce solutions across
                    blue-collar, industrial, logistics, and IT roles, supporting
                    both high-volume hiring and niche requirements. Whether it’s
                    scaling frontline teams or closing critical technical
                    positions, we focus on speed, precision, and reliability.
                  </p>

                  <p>
                    What sets us apart is our execution. We don’t just source
                    profiles—we understand role expectations, screen rigorously,
                    and deliver candidates who are ready to contribute from day
                    one.
                  </p>
                </div>
              </AnimatedContent>
              ...
              <AnimatedContent direction="right" delay={0.2}>
                <div className="bg-maxera-dark p-8 sm:p-10 md:p-12 text-white relative overflow-hidden group">
                  ...
                  <h3 className="text-xl sm:text-2xl font-black mb-6 uppercase tracking-tight relative z-10 leading-tight">
                    With strong market intelligence and a structured recruitment
                    approach, we help businesses:
                  </h3>
                  ...
                  <ul className="space-y-6 relative z-10">
                    {[
                      ...
                      <li key={i} className="flex items-start gap-4">
                        <CheckCircle
                          className="text-maxera-red mt-1 shrink-0"
                          size={20}
                        />
                        <span className="font-bold text-gray-300 uppercase text-xs sm:text-sm tracking-wide">
                          {benefit}
                        </span>
                      </li>
                    ))}
                  ...
                  <div className="mt-12 pt-8 border-t border-white/10 relative z-10">
                    <p className="text-sm sm:text-base text-gray-400 font-medium italic leading-relaxed">
                      &quot;At Maxera Talent, we operate as an extension of your
                      team—aligned to your goals, responsive to your timelines,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
            ...
            <AnimatedContent direction="left">
              <div className="bg-white p-8 sm:p-12 md:p-16 h-full border border-gray-100 shadow-xl relative overflow-hidden group">
                ...
                <span className="text-maxera-red font-black text-xs tracking-[0.5em] uppercase mb-6 block">
                  Our Mission
                </span>
                <h3 className="text-xl sm:text-2xl md:text-3xl font-heading font-black text-maxera-dark leading-[1.3] tracking-tighter">
                  &quot;To solve hiring challenges through{" "}
                  <span className="text-maxera-red">
                    fast, precise, and accountable
                  </span>{" "}
                  recruitment—delivering candidates who are vetted, relevant,
            ...
            <AnimatedContent direction="right" delay={0.2}>
              <div className="bg-maxera-dark p-8 sm:p-12 md:p-16 h-full shadow-2xl relative overflow-hidden group">
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl font-heading font-black text-white leading-[1.3] tracking-tighter">
                  &quot;To become a trusted staffing partner for businesses
                  seeking{" "}
                  <span className="text-maxera-red">
                    scalable, reliable, and high-impact
                  </span>{" "}
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-8">
            <ValueCard
              ...
              title="Integrity"
              delay={0}
              description="We operate with complete transparency and honesty in all interactions."
            />
            <ValueCard
              icon={Zap}
              title="Speed & Precision"
              delay={0.1}
              description="We understand urgency, but never sacrifice quality for speed."
            />
            <ValueCard
              icon={Heart}
              title="Partnership"
              delay={0.2}
              description="We act as an extension of your team, not just a vendor."
            />
            <ValueCard
              icon={CheckCircle}
              title="Excellence"
              delay={0.3}
              description="We strive for perfection in our screening and placement processes."
            />
          </div>
        </div>
      </section>
