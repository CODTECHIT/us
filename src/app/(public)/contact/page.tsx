...
export default function Contact() {
  ...
  const onSubmit = async (data: ContactForm) => {
    ...
    try {
      ...
      if (response.ok) {
        alert(
          "Strategic inquiry transmitted successfully! Our team will respond within 24 hours.",
        );
      } else {
  ...
  return (
    <div className="bg-white min-h-screen pb-16 sm:pb-24 md:pb-40 page-transition">
      ...
      <section className="pt-28 sm:pt-32 md:pt-40 pb-10 sm:pb-14 md:pb-20 bg-maxera-red text-white relative overflow-hidden mb-10 sm:mb-16 md:mb-24">
        <Aurora
          colorStops={["#ff4d6d", "#C6093C", "#8B0000"]}
          amplitude={1.0}
          blend={0.4}
          speed={0.3}
        />
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-12 relative z-10">
          ...
          <p className="text-white/80 text-sm sm:text-base md:text-xl max-w-2xl font-medium leading-relaxed uppercase tracking-tight">
            Direct communication channels for institutional and professional
            inquiries.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 md:gap-16 lg:gap-20">
          ...
          <AnimatedContent direction="up" className="lg:col-span-5">
            <div className="bg-maxera-dark text-white p-8 sm:p-10 md:p-12 lg:p-16 xl:p-20 relative overflow-hidden shadow-2xl">
              ...
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-heading font-black mb-8 sm:mb-10 md:mb-16 uppercase tracking-tighter">
                Reach Out
              </h3>
                ...
                {[
                  {
                    ...
                    value: "MEvans@maxeratalent.com",
                  },
                  {
                    icon: Phone,
                    label: "Strategic Lead",
                    value: "+1 (612)-515-7159",
                  },
                  {
                    icon: MessageSquare,
                    label: "Mark Evans",
                    value: "Director - Workforce Solutions",
                  ...
                  <div key={label} className="flex items-start group">
                    ...
                    <div className="min-w-0">
                      <p className="font-black text-gray-500 uppercase tracking-widest text-[10px] mb-1 sm:mb-2 md:mb-3">
                        {label}
                      </p>
                      <p
                        className={`text-base sm:text-lg md:text-xl font-bold tracking-tight break-normal ${valueClassName ?? ""}`}
                      >
                        {value}
                      </p>
                    </div>
              ...
              <div className="mt-12 sm:mt-16 md:mt-32 pt-8 md:pt-16 border-t border-white/5">
                <p className="font-black uppercase tracking-[0.3em] text-xs text-maxera-red mb-5 md:mb-10">
                  Strategic Networks
                </p>
                <div className="flex gap-4 sm:gap-6 md:gap-8">
                  {[
                    {
                      Icon: "fa-linkedin-in",
                      href: "https://www.linkedin.com/company/116164276/",
                    },
                  ].map((social, idx) => (
                    <a
                      key={idx}
                      href={social.href}
                      className="w-10 h-10 sm:w-12 sm:h-12 border border-white/10 flex items-center justify-center hover:bg-white hover:text-black transition-all"
                    >
          ...
          >
            <div className="bg-maxera-gray p-6 sm:p-8 md:p-12 lg:p-16 xl:p-20 relative border-t-4 md:border-t-8 border-maxera-red">
              <h2 className="text-2xl sm:text-3xl font-heading font-black text-maxera-dark mb-6 sm:mb-8 md:mb-12 uppercase tracking-tighter">
                Inquiry Portal
              </h2>
              ...
              >
                ...
                <button
                  ...
                  className="w-full bg-maxera-red text-white py-5 sm:py-6 md:py-8 font-black flex items-center justify-center group hover:bg-maxera-dark transition-all shadow-xl active:scale-95 disabled:bg-gray-400"
                >
                  <span className="flex items-center uppercase tracking-widest text-xs sm:text-sm transition-transform group-hover:scale-105">
                    ...
                    {!isSubmitting && (
                      <Send
                        className="ml-3 md:ml-4 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform"
                        size={16}
                      />
                    )}
                  </span>
              ...
              <div className="mt-6 sm:mt-8 md:mt-12 p-5 sm:p-6 md:p-8 bg-white border border-gray-100 flex items-center justify-between">
                <p className="text-gray-400 font-black text-[9px] sm:text-[10px] uppercase tracking-widest leading-none">
                  Response Window: &lt; 24 Hours
                </p>
                <MessageSquare
                  className="text-maxera-red opacity-20 flex-shrink-0"
                  size={20}
                />
              </div>
            </div>
