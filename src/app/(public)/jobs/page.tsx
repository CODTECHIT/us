    ...
    <div className="bg-maxera-gray min-h-screen pb-40">
      ...
      <section className="bg-maxera-dark py-32 mb-24 relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-12 relative z-10">
          ...
          <p className="text-gray-400 text-xl max-w-2xl font-medium leading-relaxed uppercase tracking-tight">
            Active institutional placements & leadership searches.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-12">
        <div className="space-y-12">
          {jobs.length === 0 ? (
            <div className="bg-white p-20 text-center shadow-soft border-l-8 border-l-maxera-red">
              <h3 className="text-3xl font-heading font-black text-maxera-dark mb-4 uppercase tracking-tight">
                NO ACTIVE SEARCHES
              </h3>
              <p className="text-gray-500 font-medium">
                We are currently updating our strategic pipeline. Please check
                back shortly.
              </p>
            </div>
          ) : (
        ...
        <div className="mt-32 p-16 bg-white shadow-soft text-center group relative overflow-hidden">
          ...
          <p className="text-gray-500 font-medium mb-12 max-w-xl mx-auto leading-relaxed">
            ...
            Synchronize your profile with our talent unit for priority matching.
          </p>
          <Link
            href="/candidates"
            className="skew-btn bg-maxera-red px-14 py-6 inline-block text-white font-black uppercase tracking-widest hover:bg-maxera-dark transition-all shadow-2xl"
          >
