...
import { ArrowRight, Clock, User, Share2, ArrowLeft, Target, Calendar } from "lucide-react";
import Image from "next/image";
import Link from "next/link";

export default function TalentInsightsClient({ initialArticles }: { initialArticles: any[] }) {
  ...
  const staticArticles = [
    {
      ...
      summary: "Many companies accept 45–60 days to fill blue‑collar roles as “normal,” but long vacancies quietly damage your operations.",
      content: (
        <div className="space-y-12">
          ...
          <section>
            <h3 className="text-2xl font-black mb-6 flex items-center"><span className="text-maxera-red mr-4">1.</span> Pay and shifts don’t match the local market</h3>
          ...
          <section>
            <h3 className="text-2xl font-black mb-6 flex items-center"><span className="text-maxera-red mr-4">2.</span> The role on paper doesn’t match the real job</h3>
          ...
          <section>
            <h3 className="text-2xl font-black mb-6 flex items-center"><span className="text-maxera-red mr-4">3.</span> Your hiring process is too slow for this talent market</h3>
            ...
            <p className="font-bold text-maxera-dark mb-4">Typical slowdowns include:</p>
            <ul className="space-y-2 mb-6 ml-4">
          ...
          <section>
            <h3 className="text-2xl font-black mb-6 flex items-center"><span className="text-maxera-red mr-4">4.</span> You’re sourcing from the wrong channels</h3>
          ...
          <section>
            <h3 className="text-2xl font-black mb-6 flex items-center"><span className="text-maxera-red mr-4">5.</span> Onboarding and retention are an afterthought</h3>
    ...
    },
    {
      ...
      summary: "AI is reshaping job content in every sector, yet companies still struggle to find people with the right mix of technical and human skills.",
      content: (
        <div className="space-y-12">
          <p className="text-xl font-bold text-maxera-dark/80 leading-relaxed bg-maxera-gray p-8 border-l-8 border-maxera-red">
          ...
          <section>
            <h3 className="text-2xl font-black mb-6 flex items-center"><span className="text-maxera-red mr-4">1.</span> Growth has shifted into a few powerful sectors</h3>
            ...
            <p className="font-bold text-maxera-dark mb-4">Examples of in‑demand areas:</p>
            <ul className="space-y-4 mb-8 ml-4 font-bold">
              <li>• AI and data: AI engineers, data scientists, ML developers, data analysts.</li>
              <li>• Cybersecurity: analysts, incident responders, security engineers.</li>
              <li>• Health and health‑tech: nurses, healthcare administrators, telehealth professionals, healthcare data analysts.</li>
              <li>• Green energy: renewable energy engineers, project managers, technicians in solar and wind.</li>
            </ul>
            <div className="bg-maxera-dark text-white p-8 mt-8">
              <h4 className="text-maxera-red font-black text-xs uppercase tracking-[0.2em] mb-4">What to do</h4>
              <ul className="text-sm space-y-3 opacity-90 list-disc pl-5">
                <li>Define clearly which growth pockets matter to you.</li>
                <li>Adjust your sourcing, employer branding, and compensation strategy to those specific pockets.</li>
          ...
          <section>
            <h3 className="text-2xl font-black mb-6 flex items-center"><span className="text-maxera-red mr-4">2.</span> Skills now matter more than titles and degrees</h3>
            <p>The talent market is moving rapidly toward skills‑based hiring, where employers care more about what people can do than the exact degree they hold. This is driven by AI, automation, and constant tech change.</p>
            ...
            <ul className="space-y-4 mb-8 ml-4">
              ...
              <li>• The most valuable people are those who combine technical depth with strong human skills.</li>
            </ul>
            <div className="bg-maxera-dark text-white p-8 mt-8">
              <h4 className="text-maxera-red font-black text-xs uppercase tracking-[0.2em] mb-4">What to do</h4>
              <ul className="text-sm space-y-3 opacity-90 list-disc pl-5">
                <li>Rewrite job descriptions to emphasize skills and outcomes instead of long lists of filters.</li>
                <li>Accept non‑traditional talent pipelines—bootcamps, certifications, internal cross‑moves.</li>
          ...
          <section>
            <h3 className="text-2xl font-black mb-6 flex items-center"><span className="text-maxera-red mr-4">3.</span> AI is changing roles faster than HR processes</h3>
            <p>In many industries, AI is already doing parts of the job—data prep, documentation, basic analysis—which changes what you actually need from people.</p>
            <p className="font-bold text-maxera-dark mb-4">What’s happening:</p>
            <ul className="space-y-4 mb-8 ml-4">
              <li>• Entry‑level white‑collar tasks are being automated, shrinking some junior roles.</li>
              <li>• In tech, AI is augmenting developers, so problem‑solving and system design become more valuable.</li>
              <li>• In healthcare, AI is supporting diagnostics, increasing demand for people at the intersection of tech and domain expertise.</li>
            </ul>
            <div className="bg-maxera-dark text-white p-8 mt-8">
              <h4 className="text-maxera-red font-black text-xs uppercase tracking-[0.2em] mb-4">What to do</h4>
              <ul className="text-sm space-y-3 opacity-90 list-disc pl-5">
                <li>Audit your key roles and identify: which tasks can AI handle.</li>
                <li>Update job requirements and interview questions to focus on adaptation and learning ability.</li>
                <li>Position your company as a place where people learn to use AI.</li>
              </ul>
            </div>
          </section>

          <section>
            <h3 className="text-2xl font-black mb-6 flex items-center"><span className="text-maxera-red mr-4">4.</span> Talent shortages and surpluses now coexist</h3>
            <p>One of the most confusing things in 2026 is that you can have a talent shortage and a talent surplus at the same time.</p>
            <p className="font-bold text-maxera-dark mb-4">Examples:</p>
            <ul className="space-y-4 mb-8 ml-4">
              <li>• Many entry‑level generalist positions have more applicants than openings.</li>
              <li>• Highly skilled roles in AI, cybersecurity, and renewable energy face sustained shortages.</li>
              <li>• Healthcare continues to drive a large share of net job growth.</li>
            </ul>
            <div className="bg-maxera-dark text-white p-8 mt-8">
              <h4 className="text-maxera-red font-black text-xs uppercase tracking-[0.2em] mb-4">What to do</h4>
              <ul className="text-sm space-y-3 opacity-90 list-disc pl-5">
                <li>Stop using one hiring strategy for everything; segment roles into scarce, balanced, and high‑supply.</li>
                <li>For scarce roles: move faster, pay competitively, and build long‑term pipelines.</li>
                <li>For high‑supply roles: tighten your screening for quality and fit.</li>
              </ul>
            </div>
          </section>

          <section>
            <h3 className="text-2xl font-black mb-6 flex items-center"><span className="text-maxera-red mr-4">5.</span> Workers are demanding real development</h3>
            <p>Across industries, candidates expect employers to help them grow—not just give them a job.</p>
            <p className="font-bold text-maxera-dark mb-4">Trends:</p>
            <ul className="space-y-4 mb-8 ml-4">
              <li>• Companies are investing more in internal learning programs and frontline training.</li>
              <li>• Workers actively look for roles where they can gain valued skills (AI tools, cloud, data literacy).</li>
              <li>• Employers that ignore upskilling risk higher turnover.</li>
            </ul>
            <div className="bg-maxera-dark text-white p-8 mt-8">
              <h4 className="text-maxera-red font-black text-xs uppercase tracking-[0.2em] mb-4">What to do</h4>
              <ul className="text-sm space-y-3 opacity-90 list-disc pl-5">
                <li>Make a short, concrete development promise part of your employer brand.</li>
                <li>Tie your staffing and recruitment strategy to reskilling.</li>
                <li>Use your hiring partners to identify candidates who show learning agility.</li>
              </ul>
            </div>
          </section>

          <section>
            <h3 className="text-2xl font-black mb-6 flex items-center"><span className="text-maxera-red mr-4">6.</span> Blended staffing models are becoming the norm</h3>
            <p>With uncertainty and rapid change, many companies are moving to blended talent models—mixing full‑time hires, contractors, and consultants.</p>
            <div className="bg-maxera-dark text-white p-8 mt-8">
              <h4 className="text-maxera-red font-black text-xs uppercase tracking-[0.2em] mb-4">What to do</h4>
              <ul className="text-sm space-y-3 opacity-90 list-disc pl-5">
                <li>Decide which roles must be permanent and which can be flexible.</li>
                <li>Build a clear playbook: when to use direct hire, contract, or RPO.</li>
                <li>Work with a partner who understands multiple industries and models.</li>
              </ul>
            </div>
          </section>
        </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-12">
          ...
          <section>
            <h3 className="text-2xl font-black mb-6 flex items-center"><span className="text-maxera-red mr-4">1.</span> Human skills are now the long‑term differentiator</h3>
            <p>Despite all the focus on technology, human strengths are becoming more valuable, not less. Research and employer surveys consistently list adaptability, analytical thinking, communication, and emotional intelligence among the most important skills.</p>
            <p className="font-bold text-maxera-dark mb-4">Key human skills in demand:</p>
            <ul className="space-y-4 mb-8 ml-4">
              <li>• <strong>Adaptability and continuous learning:</strong> ability to keep up as tools and processes change.</li>
              <li>• <strong>Analytical thinking and problem‑solving:</strong> making sense of complex information.</li>
              <li>• <strong>Communication and collaboration:</strong> working effectively across teams.</li>
              <li>• <strong>Emotional intelligence and leadership:</strong> managing oneself and others.</li>
            </ul>
            <div className="bg-maxera-dark text-white p-8 mt-8">
              <h4 className="text-maxera-red font-black text-xs uppercase tracking-[0.2em] mb-4">What employers should do</h4>
              <ul className="text-sm space-y-3 opacity-90 list-disc pl-5">
                <li>Make these skills visible in job descriptions and interviews.</li>
                <li>Use structured questions and scenarios that test how candidates learn and adapt.</li>
          ...
          <section>
            <h3 className="text-2xl font-black mb-6 flex items-center"><span className="text-maxera-red mr-4">2.</span> AI and data skills cut across nearly every role</h3>
            <p>AI and data capabilities have moved from niche to mainstream in many organizations. Companies across sectors are investing in AI and analytics.</p>
            <p className="font-bold text-maxera-dark mb-4">In‑demand technical areas include:</p>
            <ul className="space-y-4 mb-8 ml-4 font-bold">
              <li>• AI and machine learning: using and integrating AI tools.</li>
              <li>• Data analysis and business analytics: turning data into decisions.</li>
              <li>• Cybersecurity: protecting systems and data as digital risk grows.</li>
              <li>• Cloud and modern infrastructure (AWS, Azure, etc.): running scalable environments.</li>
            </ul>
            <div className="bg-maxera-dark text-white p-8 mt-8">
              <h4 className="text-maxera-red font-black text-xs uppercase tracking-[0.2em] mb-4">What employers should do</h4>
              <ul className="text-sm space-y-3 opacity-90 list-disc pl-5">
                <li>Decide which roles in your company need deep AI/data expertise.</li>
                <li>Update job ads to highlight exposure to AI tools.</li>
                <li>Offer targeted training so current employees can build basic AI and data skills.</li>
              </ul>
            </div>
          </section>

          <section>
            <h3 className="text-2xl font-black mb-6 flex items-center"><span className="text-maxera-red mr-4">3.</span> Skills‑first hiring is replacing rigid degree filters</h3>
            <p>A strong trend in 2026 is “skills‑first hiring”—prioritizing what candidates can actually do over traditional requirements.</p>
            <p className="font-bold text-maxera-dark mb-4">What’s changing:</p>
            <ul className="space-y-4 mb-8 ml-4">
              <li>• Non‑traditional paths (bootcamps, internal reskilling) are increasingly accepted.</li>
              <li>• Structured assessments and skill tests are used to evaluate candidates.</li>
              <li>• Internal mobility is becoming a core talent strategy.</li>
            </ul>
            <div className="bg-maxera-dark text-white p-8 mt-8">
              <h4 className="text-maxera-red font-black text-xs uppercase tracking-[0.2em] mb-4">What employers should do</h4>
              <ul className="text-sm space-y-3 opacity-90 list-disc pl-5">
                <li>Review your job descriptions and remove unnecessary barriers.</li>
                <li>Introduce simple, role‑relevant skill assessments for key positions.</li>
                <li>Work with partners who can help you identify candidates with the right skill mix.</li>
              </ul>
            </div>
          </section>

          <section>
            <h3 className="text-2xl font-black mb-6 flex items-center"><span className="text-maxera-red mr-4">4.</span> Technical field and operations roles are becoming digital</h3>
            <p>Even in traditionally “hands‑on” industries, the most valued professionals now work with digital tools and telematics.</p>
            <p className="font-bold text-maxera-dark mb-4">Examples:</p>
            <ul className="space-y-4 mb-8 ml-4">
              <li>• Construction: technicians who understand telematics and IoT sensors.</li>
              <li>• Automation: engineers skilled in PLCs and systems integration.</li>
              <li>• Service roles: professionals who use data dashboards to reduce downtime.</li>
            </ul>
            <div className="bg-maxera-dark text-white p-8 mt-8">
              <h4 className="text-maxera-red font-black text-xs uppercase tracking-[0.2em] mb-4">What employers should do</h4>
              <ul className="text-sm space-y-3 opacity-90 list-disc pl-5">
                <li>Update role definitions to include digital and analytics expectations.</li>
                <li>Offer training in the specific platforms and tools you use.</li>
                <li>Emphasize these digital elements in your employer branding.</li>
              </ul>
            </div>
          </section>

          <section>
            <h3 className="text-2xl font-black mb-6 flex items-center"><span className="text-maxera-red mr-4">5.</span> Building a future‑ready workforce</h3>
            <p>Because technology changes so quickly, organizations are investing in continuous upskilling and reskilling programs.</p>
            <p className="font-bold text-maxera-dark mb-4">Current approaches:</p>
            <ul className="space-y-4 mb-8 ml-4">
              <li>• Internal academies for both technical and soft skills.</li>
              <li>• Partnerships with training providers for AI, cloud, and cybersecurity.</li>
              <li>• Clear communication to employees about which skills the organization values.</li>
            </ul>
            <div className="bg-maxera-dark text-white p-8 mt-8">
              <h4 className="text-maxera-red font-black text-xs uppercase tracking-[0.2em] mb-4">What employers should do</h4>
              <ul className="text-sm space-y-3 opacity-90 list-disc pl-5">
                ...
                <li>Incorporate learning and adaptability into performance reviews.</li>
              </ul>
            </div>
          </section>
        </div>
              ...
              <div className="lg:col-span-8 grid gap-12">
                {allArticles.length === 0 ? (
                  <div className="p-20 border-2 border-dashed border-zinc-100 text-center rounded-2xl">
                    <p className="text-zinc-400 font-bold uppercase tracking-widest text-sm">No insights published yet.</p>
                  </div>
                ) : (
                      ...
                      <div className="grid md:grid-cols-5 gap-8 items-center">
                        ...
                        <div className="md:col-span-3">
                          <div className="flex items-center gap-4 text-[10px] font-black text-maxera-red uppercase tracking-widest mb-4">
                            <span suppressHydrationWarning>{new Date(article.createdAt).toDateString()}</span>
                          ...
                          <p className="text-gray-500 font-medium mb-6 line-clamp-2">
                            {article.summary || article.excerpt || "Read our latest analysis on this industry topic."}
                          </p>
            ...
            >
              <article className="lg:col-span-8">
                ...
                <div className="flex flex-wrap items-center gap-6 text-gray-400 text-[10px] font-black uppercase tracking-[0.2em] mb-12 pb-8 border-b border-gray-100">
                  <div className="flex items-center"><Clock size={14} className="mr-2 text-maxera-red" /> {selectedArticle.readTime || "8 Min Read"}</div>
                  <div className="flex items-center"><User size={14} className="mr-2 text-maxera-red" /> {selectedArticle.author || 'Maxera Admin'}</div>
                  <div className="flex items-center" suppressHydrationWarning><Calendar size={14} className="mr-2 text-maxera-red" /> {new Date(selectedArticle.createdAt).toDateString()}</div>
                </div>
