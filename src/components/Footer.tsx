      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 sm:gap-12 lg:gap-16 xl:gap-24 mb-12 md:mb-24">
          ...
          <div className="lg:col-span-2">
            <h4 className="text-white font-black mb-5 md:mb-10 text-[13px] md:text-[14px] uppercase tracking-[0.2em] border-l-4 border-maxera-red pl-4">
              Company
            </h4>
            <ul className="space-y-3 md:space-y-4 text-sm md:text-[15px] font-bold">
              <li>
                <Link
                  href="/about"
                  className="hover:text-maxera-red transition-all flex items-center group"
                >
            ...
            <div className="space-y-5 md:space-y-8 text-sm md:text-[15px] font-bold">
              <div className="space-y-6">
                <div className="flex items-start">
                  <MapPin
                    className="text-maxera-red mr-3 md:mr-5 mt-1 flex-shrink-0"
                    size={18}
                  />
                  <div className="flex flex-col">
                    <span className="text-white font-black text-[9px] uppercase tracking-widest mb-1">
                      USA (Client Engagement Office)
                    </span>
                    <p className="text-gray-400 text-xs sm:text-[13px] leading-relaxed text-justify">
                      1710 Douglas Dr N #209a, <br /> Golden Valley, MN 55422,
                      USA
                    </p>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-gray-400 text-xs sm:text-[13px] leading-relaxed text-justify">
                      <span className="whitespace-nowrap">
                        Rajapushpa House, Cyber Hills Colony,
                      </span>
                      <br /> Madhapur, Hyderabad, TS 500081
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-gray-400 text-xs sm:text-[13px] leading-relaxed text-justify">
                      Kruthi Kastle, Nandihills, Meerpet, <br /> Hyderabad, TS
                      500097
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-center group">
                ...
                <div className="flex flex-col">
                  <span className="text-gray-500 font-black text-[9px] uppercase tracking-widest mb-0.5">
                    Direct Inquiry
                  </span>
                  <span className="text-white text-xs sm:text-sm md:text-[15px] font-bold">
